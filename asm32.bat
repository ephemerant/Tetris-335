...
rem Visual Studio 2012 (or Visual Studio 2012 Express).  This batch file runs
...
rem  C:\Program Files\Microsoft Visual Studio 12, you must modify the 
...
rem  Studio 2012 (or Visual C++ 2012 Express)
rem -----------------------------------------------------------------
set VS_HOME=C:\Program Files\Microsoft Visual Studio 11.0
...
for %%F in (%1 %2 %3 %4 %5) do "C:\Program Files (x86)\Microsoft Visual Studio 14.0\VC\bin\ml.exe" -nologo -c -Zi %%F.asm
...
echo directory: C:\Program Files\Microsoft Visual Studio 11.0
echo.
...
echo the following directory: C:\Program Files\Microsoft Visual Studio 11.0\VC\bin
echo.
